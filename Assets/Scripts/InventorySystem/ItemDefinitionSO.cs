...
public class ItemDefinitionSO : ItemDefinitionSOBase, IEnumStringKeyedEntry<Key_ItemDefinitionPP>
{
    [Header("Keys")]
    [SerializeField] private Key_ItemDefinitionPP enumKey;
    ...
    public Key_ItemDefinitionPP EnumKey => enumKey;
